...
public class MessagesDetailFragment extends Fragment {
	...
	public static Fragment newInstance(int sessionID){  
        ...
        bundle.putInt(ARG_SESSIONID, sessionID);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.messages_detail_fragment, null);
		return v;
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if(null != savedInstanceState){
			...
			//动态设置标题
			mTitle = this.getString(R.string.title_messages) + this.getArguments().getInt(ARG_SESSIONID);
		}
